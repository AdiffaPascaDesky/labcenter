...
<div class="vendor-index">
    ...
    <div class="d-flex justify-content-end py-3">
        <a href="/vendor/create" class="bg-primary btn text-white">
            Tambah
        </a>
    </div>
                                ...
                                <td><?= $item['nama'] ?? 'N/A' ?></td>
                                    ...
                                    <td>
                                        <div class="d-flex gap-3 justify-content-center items-center">
                                            <a href="/vendor/view?id=<?= $item['id'] ?>" class="d-flex text-primary">
                                            ...
                                            <a href="/vendor/update?id=<?= $item['id'] ?>" class="d-flex text-warning">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form action="/vendor/delete?id=<?= $item['id'] ?>" method="post">
