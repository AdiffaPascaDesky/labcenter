...
/** @var app\models\PinjamInternalSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Pinjam Internals';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="pinjam-internal-index">

    <h1><?= Html::encode($this->title) ?></h1>

    <div class="d-flex justify-content-end py-3">
        <a href="/pinjam-internal/create" class="bg-primary btn text-white">
            Tambah
        </a>
    </div>
    <div class="card">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <div class="modal fade" id="edit-<?= $item['id'] ?>" tabindex="-1">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="pinjam-internal/updatelainnya?id=<?= $item['id'] ?>" method="post">
                            ...
                            <td class="d-flex gap-3 justify-content-center items-center">
                                <a href="/pinjam-internal/update?id=<?= $item['id'] ?>" class="d-flex text-warning">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    data-bs-dismiss="modal">Tidak</button>
                                                <form action="/pinjam-internal/delete?id=<?= $item['id'] ?>"
                                                    method="post">
                                                    <?= Html::hiddenInput(Yii::$app->request->csrfParam, Yii::$app->request->csrfToken); ?>
                                                    <input type="hidden" value="<?= $item['id'] ?>" name="id">
